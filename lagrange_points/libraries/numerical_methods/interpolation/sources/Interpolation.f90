...
!*************************************************************************************************************
!* Computes the Chebyshev polynomial interpolation  from data f(:)
!*************************************************************************************************************
function Chebyshev_Interpolant(f, xp )
          real, intent(in) ::  f(0:), xp(0:) 
          real :: Chebyshev_Interpolant(0:size(f)-1, 0:size(xp)-1)

          ! Chebyshev coefficients and their derivatives 
          ! Interpolant and its derivatives 
          
          Chebyshev_Interpolant = 0 
